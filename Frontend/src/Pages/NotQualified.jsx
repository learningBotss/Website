...
export default function NotQualified() {
  ...
  return (
    <div className="bg-gradient-hero flex flex-col items-center justify-center p-6">
...
This screening is not a diagnosis. If you experience learning challenges in the future, you may retake the test or consult an educational professional.</p>
        <button onClick={()=>nav("/")} className="px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 ">Back to Home</button>
      </div>
    </div>
  );
}
